...
function normalizeOptionalBranch(branch?: string | null): string | null {
  const normalized = branch?.trim();
  return normalized ? normalized : null;
}

function buildDefaultTaskBranch(taskId: string, now: Date): string {
